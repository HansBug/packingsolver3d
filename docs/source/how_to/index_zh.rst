...
任务指南是任务导向的页面：假定你已经知道 packingsolver3d 是什么，只告诉你怎么把一件事做完。第一次上手请看 :doc:`/tutorials/index_zh`；查精确表格请看 :doc:`/reference/index_zh`；要了解某个行为背后的原因请看 :doc:`/explanations/index_zh`。
