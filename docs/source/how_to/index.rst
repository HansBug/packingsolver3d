...
How-to guides are task pages: each assumes you already know what packingsolver3d is and tells you how to get one job done. For a first tour use :doc:`/tutorials/index`; for exact tables use :doc:`/reference/index`; for the reasoning behind a behaviour use :doc:`/explanations/index`.
