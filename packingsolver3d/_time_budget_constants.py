...
PATHS = {
    ('box', 'SSK'): {
        ...
        'beta': [-7.3358, 1.2766, 1.0847], 'block': 0.000, 'scale': 0.880,
    ...
    ('box', 'SVC'): {
        ...
        'beta': [-3.3192, 0.0, 2.4422], 'block': 0.000, 'scale': 0.461,
        'm': {0.25: 0.0, 0.5: 0.0, 1.0: 0.0, 1.5: 0.0, 2.0: 0.0, 3.0: 0.0, 4.0: 0.0, 6.0: 0.0, 8.0: 0.0},
    ...
    ('box', 'TS'): {
        ...
        'beta': [-2.515, 0.0, 0.1722], 'block': 0.000, 'scale': 0.461,
    ...
    ('box', 'TSMS'): {
        ...
        'beta': [-8.7532, 1.2677, 0.7096], 'block': 0.965, 'scale': 0.433,
    ...
    ('boxstacks', 'SOR'): {
        ...
        'beta': [-4.7479, 0.4148, 1.0779, 1.9462], 'block': 0.000, 'scale': 0.524,
    ...
    ('boxstacks', 'SVC'): {
        ...
        'beta': [-2.8245, 1.2516, 0.2625], 'block': 0.000, 'scale': 0.895,
        'm': {0.25: 0.0, 0.5: 0.0, 1.0: 0.0, 1.5: 0.0, 2.0: 0.0, 3.0: 0.0, 4.0: 0.0, 6.0: 0.0, 8.0: 0.0},
        'add': {0.25: 0.0, 0.5: 0.0, 1.0: 0.0, 1.5: 0.0, 2.0: 0.0, 3.0: 0.0, 4.0: 0.0, 6.0: 0.0, 8.0: 0.0},
    },
}
